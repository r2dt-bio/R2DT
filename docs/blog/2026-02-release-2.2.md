...
When processing [R-scape](https://doi.org/10.1038/nmeth.4066) Stockholm files, R2DT now automatically detects covariation annotations and generates a second SVG with coloured rectangles behind base pairs indicating statistically significant covariation. See [Covariation visualisation](../covariation.md) for details.
...
- Added [XRNA-React user manual](https://r2dt.readthedocs.io/en/latest/xrna-react-user-guide.html) (XRNA-React has since been renamed to [Exornata](https://exornata.chemistry.gatech.edu/))
